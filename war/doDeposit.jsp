...
<div id="ddblueblockmenu">
  ...
  <ul>
    <li><a href="main.jsp">Welcome,&nbsp;<%= (String)session.getAttribute("username")%></a></li>
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<div class="box2">
	Your Amount is Successfully Deposited into Account. Your current Balance is: <font color="#FF0000"> Rs.<%= (Integer)session.getAttribute("Amount")%> </font><br/>
