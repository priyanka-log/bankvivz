...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<br/>
	<form id="form1" name="form1" method="post" action="/get-balance-final">
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td><div align="right"><strong>Account Holder Number </strong></div></td>
          <td>:</td>
          <td><label>
            <input name="accnumber" type="text" id="accnumber"  />
          </label></td>
        </tr>
       <%--  <tr>
