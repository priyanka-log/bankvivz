	...
	<form id="form1" name="form1" method="post" action="">
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td><div align="right"><strong>:</strong></div></td>
           <td><%= (Integer)session.getAttribute("accnumber")%></td> 
        </tr>
        <tr>
          <td><div align="right"><strong>Current Balance </strong></div></td>
          <td><div align="right"><strong>:</strong></div></td>
          <td>&nbsp;<font color="#FF0000"> Rs. <%= (Integer)session.getAttribute("Amount")%></font></td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;If you want to Deposit then <a href="deposit.jsp">Click Here</a><br/> Or For Withdraw the Amount from Your Account <a href="withdraw.jsp">Click here</a></td>
          </tr>
        <tr>
          <td width="43%">&nbsp;</td>
          <td width="2%">&nbsp;</td>
